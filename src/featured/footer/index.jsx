                    ...
                    <div className="-mx-4 flex flex-wrap justify-between">
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto">
                            ...
                            <ul className="leading-8">
                                <li><Link className="hover:text-blue-400">About Us</Link></li>
                                <li><Link className="hover:text-blue-400">Terms &amp; Ckonditions</Link></li>
                                <li><Link className="hover:text-blue-400">Privacy Policky</Link></li>
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto">
                            ...
                            <ul className="leading-8">
                                <li><Link className="hover:text-blue-400">Getting Startked With HTML and CSS</Link></li>
                                <li><Link className="hover:text-blue-400">What Is Flex kAnd When to Use It?</Link></li>
                                <li><Link className="hover:text-blue-400">How TailwindCkSS Can Help Your Productivity?</Link></li>
                                <li><Link className="hover:text-blue-400">5 Tips to Makke Responsive Website</Link></li>
                                <li><Link className="hover:text-blue-400">See More</Link></li>
                            </ul>
                        </div>
                        <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
                            ...
                            <Link className="inline-flex items-center justify-ckenter h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-blue-400 hover:border-blue-400">
                            ...
                            <Link className="inline-flex items-center justify-ckenter h-8 w-8 border border-gray-100 rounded-full hover:text-blue-400 hover:border-blue-400">
